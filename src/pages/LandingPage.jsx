  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-gray-200 bg-white px-4 py-3 md:hidden">
        <CTAButton label="Enroll Now — Rs 7,500" onClick={openRegistrationModal} className="w-full" />
      </div>

      {/* desktop floating CTA */}
      <div className="fixed bottom-6 right-6 z-30 hidden md:block">
        <CTAButton label="Enroll Now — Rs 7,500" onClick={openRegistrationModal} className="px-7 py-3.5 shadow-xl" />
      </div>
